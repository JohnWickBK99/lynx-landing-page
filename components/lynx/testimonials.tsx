...
const testimonials = [
  {
    name: "Sarah Chen",
    username: "@sarahtech",
    body: "Lynx AI transformed our workflow completely. The automation features saved us 40+ hours per week on routine tasks.",
    img: "/professional-woman-developer.png",
  },
  {
    name: "Marcus Rodriguez",
    username: "@marcusbuilds",
    body: "The AI-powered insights from Lynx helped us identify bottlenecks we never knew existed. Game-changing platform.",
    img: "/professional-engineer.png",
  },
  {
    name: "Emily Watson",
    username: "@emilycodes",
    body: "Implementation was seamless and the results were immediate. Our team productivity increased by 60% in the first month.",
    img: "/professional-woman-coder.jpg",
  },
  {
    name: "David Kim",
    username: "@davidai",
    body: "Lynx AI's predictive analytics helped us make data-driven decisions that boosted our revenue by 35%. Incredible ROI.",
    img: "/professional-data-scientist.png",
  },
  {
    name: "Lisa Thompson",
    username: "@lisatech",
    body: "The customer support is outstanding and the platform keeps getting better. Lynx AI is essential for modern businesses.",
    img: "/professional-woman-consultant.png",
  },
  {
    name: "Alex Johnson",
    username: "@alexdev",
    body: "From setup to scaling, Lynx AI handled everything smoothly. Our clients are amazed by the efficiency improvements.",
    img: "/professional-man-developer.png",
  },
  {
    name: "Rachel Park",
    username: "@rachelai",
    body: "The AI recommendations are spot-on and have helped us optimize processes we didn't even know needed improvement.",
    img: "/professional-woman-analyst.jpg",
  },
  {
    name: "James Wilson",
    username: "@jamesbiz",
    body: "Lynx AI delivered results from day one. The intelligent automation features are exactly what our startup needed.",
    img: "/professional-entrepreneur.png",
  },
  {
    name: "Maya Patel",
    username: "@mayatech",
    body: "The platform's intuitive design makes complex AI accessible to our entire team. Lynx AI democratizes artificial intelligence.",
    img: "/professional-woman-product-manager.png",
  },
];
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-[540px]">
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            See how businesses are transforming their operations with Lynx AI's
